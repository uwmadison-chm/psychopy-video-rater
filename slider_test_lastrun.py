...
expName = 'slider_test'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/njvack/movie-playback/slider_test_lastrun.py',
...
scale = visual.ImageStim(
    ...
    image='scale_814x144.png', mask=None,
    ori=0, pos=(0, -300), size=None,
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('emotions.csv'),
...
for thisTrial in trials:
    ...
    # update component parameters for each repeat
    text.setText(thisTrial['emotion'])
    ...
    mouse.getPos()
    # keep track of which components have finished
    trialComponents = [text, scale, mouse, indicator]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        frameRemains = 0.0 + 5- win.monitorFramePeriod * 0.75  # most of one frame period left
        if indicator.status == STARTED and t >= frameRemains:
